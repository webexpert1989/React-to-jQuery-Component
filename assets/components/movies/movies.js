...
var Movies = function(opts) {
	this.opts = {
		wrap : jQuery("[data-slider=\"movies\"]"),
		data : {},
		tpl  : {
			thumb	: "\
				<div class=\"item item-##all##\" data-item-index=\"##index##\">\
					<div class=\"item-wrap\">\
						<div class=\"img-wrap\">\
					...
					<div class=\"item-info\">\
						...
						<div class=\"item-info-elem show-##temporadas##\">\
							<div class=\"item-seasons\">\
								<span class=\"seasons\">##duration##</span>'\
							</div>\
						</div>\
					</div>\
	...
	this.bind_items = function() {
		...
		for(var i in opts.data) {
			if(opts.data[i].id == "all") {
				if(!printall) {
					var newItemHtml = opts.tpl.thumb.replace(/##id##/g, opts.data[i].id)
	...
	this.sel_slide = function(index) {
		...
		this.opts.timer = setTimeout(function() {
			if(opts.data[index].id == "all") {
				opts.itemsDesc.html(
					opts.tpl.contents.replace(/##title##/g, opts.data[index].title)
													 .replace(/##all##/g, "all")
				);
			} else {
				...
				opts.itemsDesc.html(
					opts.tpl.contents.replace(/##title##/g, opts.data[index].title)
													 ...
													 .replace(/##duration##/g, opts.data[index].duration)
													 .replace(/##desc##/g, desc)
				);
			}
